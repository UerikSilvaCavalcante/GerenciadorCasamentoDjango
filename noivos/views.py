...
def home(request):
    if request.method == 'GET':
        presente = Presentes.objects.all()
        ...
        return render(request, 'home.html', {'presentes': presente, 'data':data})
        ...
        presente = Presentes(nome_presente=nome_presente, preco=preco, importancia=importancia, foto=foto)
        presente.save()
